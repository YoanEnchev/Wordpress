...
function sydney_slider_template() {
    ...
    if ( !function_exists('pll_register_string') ) {
    	$titles = array(
			...
			'slider_title_6' => get_theme_mod('slider_title_6'),
    	);
    	$subtitles = array(
			...
			'slider_subtitle_6' => get_theme_mod('slider_subtitle_6'), 
    	);
    } else {
    	$titles = array(
			...
			'slider_title_6' => pll__( get_theme_mod('slider_title_6') ),
    	);
    	$subtitles = array(
			...
			'slider_subtitle_6' => pll__( get_theme_mod('slider_subtitle_6') ),  
    	);
    }
    $images = array(
			...
			'slider_image_6' => get_theme_mod('slider_image_6'),
    );
