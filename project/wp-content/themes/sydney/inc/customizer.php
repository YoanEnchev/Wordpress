...
function sydney_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_section(
        ...
        array(
            ...
            'description'   => __('You can add up to 6 images in the slider. Make sure you select where to display your slider from the Header Type section found above. You can also add a Call to action button (scroll down to find the options)', 'sydney'),
            'priority'      => 11,
            'panel'         => 'sydney_header_panel',
        )
    );
