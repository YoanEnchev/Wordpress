...
function aps_metabox_cb( $post ) {
    ...
    <div class="aps_shortcode">
        ...
        <textarea cols="30" rows="1" onClick="this.select();" >[adl-post-slider <?php echo 'id="'.$post->ID.'"';?>]</textarea> <br />

        <p><?php _e('If you need to put the shortcode inside php code/template file, use this:', APS_TEXTDOMAIN); ?></p>
        <textarea cols="63" rows="1" onClick="this.select();" ><?php echo '<?php echo do_shortcode("[adl-post-slider id='; echo "'".$post->ID."']"; echo '"); ?>'; ?></textarea> </p>
    </div>
<?php }
